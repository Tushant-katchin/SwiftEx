    ...
    <View>
      ...
      >
        ...
        <Card.Content>
          ...
          >
            {" "}
            Market Cap : $ {props.route.params.data.market_cap}
          </Paragraph>
          <Paragraph
            style={{ color: "#fff", marginTop: hp("3"), fontWeight: "bold" }}
          >
            {" "}
            Total Supply : {props.route.params.data.total_supply}
          </Paragraph>
          <Paragraph
            style={{ color: "#fff", marginTop: hp("3"), fontWeight: "bold" }}
          >
            {" "}
            24H high : $ {props.route.params.data.high_24h}
          </Paragraph>
          <Paragraph
            style={{ color: "#fff", marginTop: hp("3"), fontWeight: "bold" }}
          >
            {" "}
            24H low : $ {props.route.params.data.low_24h}
          </Paragraph>
          <Paragraph
            style={{ color: "#fff", marginTop: hp("3"), fontWeight: "bold" }}
          >
            {" "}
            All Time High : $ {props.route.params.data.ath}
          </Paragraph>
        </Card.Content>
      </Card>
    </View>
