  ...
  return (
    ...
    <View style={{display: 'flex',
      ...
      <TextInput
        ...
        onChangeText={(text) => setFormContent({...formContent,firstName:text})}
        autoCapitalize={"none"}
      ...
      placeholderTextColor="#FFF"
        ...
        onChangeText={(text) => setFormContent({...formContent,lastName:text})}
      />
      </View>
      <View >
      <View style={styles.icon}>
       <Text style={{color:'#FFF', marginLeft:5}}>Phone Number</Text>  
      </View>
      <PhoneInput
      ...
      <View style={styles.inp}>
      <View style={styles.icon}>
       <Text style={{color:'#FFF', marginLeft:5}}>Email address</Text>
      </View>
      <TextInput
      placeholderTextColor="#FFF"
        style={styles.input}
        ...
        onChangeText={(text) => setFormContent({...formContent,email:text})}
      />
      </View>
      <View style={styles.inp}>
      <View style={styles.icon}>
       <Text style={{color:'#FFF', marginLeft:5}}>Wallet Address</Text>
      </View>
      <TextInput
      placeholderTextColor="#FFF"
        style={styles.input}
        ...
        placeholder={state.wallet?state.wallet.address:'Wallet address'}
        disabled={true}
        onChangeText={(text) => setFormContent({...formContent,walletAddress:text})}
      />
      </View>
      {showMessage?<Text style={{color:'white'}}>{message}</Text>:<View></View>}
