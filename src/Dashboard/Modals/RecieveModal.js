...
const RecieveModal = ({ modalVisible, setModalVisible}) => {
  ...
  <TouchableOpacity style={style.Box3} onPress={()=>{
   ...
   setIconType('BNB')
        ...
        <Card  style={{width:wp(90), height:hp(10), backgroundColor:'white', borderRadius:10}}>
<Card.Title titleStyle={{ color: "black" }}  title={'BNB'}  left={BnbLeftContent}  />
...
<Title style={{color:'#fff'}}></Title>
  ...
  <TouchableOpacity style={style.Box2} onPress={()=>{
    ...
    setIconType('Matic')
        ...
        <Card  style={{width:wp(90), height:hp(10), backgroundColor:'white', borderRadius:10}}>
<Card.Title titleStyle={{ color: "black" }}  title={'Matic'}  left={maticLeftContent}  />
<Card.Content style={{display:'flex',flexDirection:'row',color:'#fff'}}>
<Title style={{color:'#fff'}}></Title>
</Card.Content>
</Card>
  ...
  <Text>Please select a wallet type</Text>
        ...
        <RecieveAddress modalVisible={visible} setModalVisible={setVisible} iconType={iconType}/>
        </Modal>
        </Animated.View>
  )
}
