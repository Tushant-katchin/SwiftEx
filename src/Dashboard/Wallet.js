...
return (
  ...
  <View
    ...
    source={title_icon}
  />
  <View style={{marginTop:hp(10),display:'flex',alignContent:'center', alignItems:'center'}}>

  <Text style={{fontSize:20,color:'black'}}>Private and secure</Text>
  ...
  <View style={styles.accountBox} >
      ...
      <Icon name="chevron-right" size={hp('5')} color="white" style={{marginLeft:wp('55'), marginTop:hp('-3')}} />
      </TouchableOpacity>
      </View>
...
<SelectWallet visible={visible} setVisible={setVisible} setModalVisible={setModalVisible}/>
<NewWalletModal visible={newWalletModal} setVisible={setNewWalletModal} setModalVisible={setModalVisible}/>
     </View>
