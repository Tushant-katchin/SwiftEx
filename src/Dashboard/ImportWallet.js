...
<Modal
  ...
  <View
    ...
    <TextInput style={styles.textInput2} onChangeText={(text) => {
        setName(text)
        ...
        const wallets = await getWallets()
          ...
          if(wallets[0].name!==undefined){
            ...
            if(valid===true){
              ...
              return alert('account with same name already exists. please use a different name')
            }else{
    ...
    <TouchableOpacity
      ...
      <Text style={styles.addButtonText}>import using mnemonic phrase</Text>
    </TouchableOpacity>
    <TouchableOpacity
